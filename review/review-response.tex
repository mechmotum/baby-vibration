...
Parents do transport newborns by bicycle in The Netherlands and it may also
occur in other countries. An extremely common question parents have is what the
minimum age for transporting an infant by bicycle is (as shown by the abudance
of internet articles). We want to characterize the full range of infant ages so
that this question can be answered definitiely in the future. For these two
reasons, we measured newborn dummies.
...
The paper has 8193 words, which we disclosed at submission. The appendices are
intended to be electronic supplementary materials and not word counted. We
provide this supplementary material to ensure the reproducibility and
