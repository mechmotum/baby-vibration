...
Ergonomic's prohibition on the active voice and it is our preferred style for
scientific writing. The six most recent papers published in Ergonomics as of
...
TODO : repetitive and overlapping sections
...
paragraph. To explain earlier in the paper why we make use of the ISO~2631
...
previous studies in ``Section 4, Discussion''. However, a direct comparison is
not possible as other studies tested different systems and body sizes.
...
time series measurements into 10-20 second repetitions resulted in independent
observations resulting from a sample from a different portion of the traversed
road in a trial. This methodology may be marginally sound, but we no longer feel
confident in this assumption holding due to the more-or-less arbitrary choice in
a 20 second maximum and little variation within a trial's road surface. Choosing
different repetition durations has effects on the observation distributions and
...
We added the following in subsection "4.2 Baby Mass": ``Due to a lack of dummies
validated for vibration conditions, we tested with dummies of representative
mass and body size. As is common for adult vibration, accelerations were
measured at the dummy-seat interface rather than on the body. This limits the
influence of the actual dynamics of the dummies.''

Regarding the issue with road surfaces, we edited the section "2.4 Experimental
Protocol" by stating as follows: ``We selected arbitrary surfaces representative
of commonly occurring urban conditions in Delft, the Netherlands. Although these
surfaces cover only part of the full range of possibilities, we travelled
various distances to capture variation in surface quality.''
