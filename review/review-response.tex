...
compare the results with other research.

Later in the Introduction, we added: 

``In the absence of infant-specific safety and comfort standards, we propose a
measurement framework to target the future development of specific ISO norms. We
equipped five strollers and two cargo bicycles with inertial measurement units
(IMU) and carried out 67 experiments across different road surfaces and travel
speeds. Although no ISO standards are currently defined for infants, we
processed data using ISO~2631-1 frequency weightings and procedures to ease
comparison with previous studies. We also report unweighted results to assess
power spectrum and bandwidth. We systematically investigated the influence of
vehicle, seat, body size, speed, and road surface, and provided recommendations
for users, designers, and researchers.''
...
We streamlined the introduction, avoiding necessary repetitions. The first three
paragraphs of the Introduction have been rewritten, making the section shorter
and more readable. 
...
According to the reviewer's suggestion, we deleted some general information that
made the paper unnecessarily lengthy. We heavily streamlined the introduction.
The overall paper has been checked against repetitions or unnecessary sentences.
...
We thank the reviewer for the suggestion. We added some comparison with previous
studies in the section ``4 Discussion''. However, a direct comparison is not
possible as we miss the supporting literature, especially for strollers.
...
To address the remark, we worked on the whole paper to make it more readable. We
edited the Introduction, avoiding unnecessary repetitions and vague sentences,
especially in the beginning. We merged subsections 3.1 and 3.2 to avoid
excessive fragmentation of the paper. A similar approach was followed in the
sections ``3 Results'' and ``4 Discussion'', resulting in smoother and shorter
paragraphs. 

BOTH have a look at reducing repetition, especially in discussion
...
We acknowledge the reviewer for the remark. Indeed, the research gap was not
clearly stated. We added the following in the Introduction. 

``Nevertheless, only a few studies focus on vibrations experienced by infants younger than 12 months. 
This paper aims to bridge this gap and, in the absence of infant-specific safety and comfort standards, proposes a measurement framework to target the future development of specific ISO norms. We equipped five strollers and two cargo bicycles with inertial measurement units (IMU) and carried out 67 experiments across different road surfaces and travel speeds. Although no ISO standards are currently defined for infants, we processed data using ISO~2631-1 frequency weightings and procedures to ease comparison with previous studies. We also report unweighted results to assess power spectrum and
bandwidth. We systematically investigated the influence of vehicle, seat, body size, speed, and
road surface, and provided recommendations for users, designers, and researchers."
...
We thank the reviewer for the suggestion. We added a comparison with previous
studies in "Section 4, Discussion". However, a direct comparison is not possible
as other studies tested different systems and body sizes.
...
and analysis from the paper, which obviates addressing this comment. In the
process of investigating this remark, we reexamined another assumption we made
for the statistics: whether our observations (each repetition) were independent.
We had convinced ourselves that dividing our long time series measurements into
10-20 second repetitions resulted in independent observations resulting from a
sample from a different portion of the traversed road in a trial. This
methodology may be sound, but we no longer feel confident in this assumption
holding due to the more-or-less arbitrary choice in a 20 second maximum and
little variation within a trial's road surface. Choosing different repetition
durations has effects on the observation distributions, including the
heteroskedasticity.
